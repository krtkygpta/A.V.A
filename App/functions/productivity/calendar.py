...
def _get_credentials():
    ...
    creds = None
    token_path = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'calendar_token.json')
    client_secrets = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'calendar_client_secrets.json')
